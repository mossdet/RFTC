    ...
    for nmi = 1:length(normOptions)
        for psi = 1:length(patsSelList)
            for fi = 1:length(features)
                ...
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature) = [];
                ...
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcDiff = biomarkerActvDiff_RFTC.in.diff;
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcConn = biomarkerActvDiff_rftcConnected.in.diff;
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).highEI = biomarkerActvDiff_highEI.in.diff;
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcStruct = sameRFTC_Structure_ActvDiff.in.diff;
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcLobe = sameRFTC_Lobe_ActvDiff.in.diff;
                predictionData.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcHemis = sameRFTC_Hemisphere_ActvDiff.in.diff;
                
                prePostPs = {'rftcSite', 'highEI', 'rftcConnected', 'rftcStructure', 'rftcLobe', 'rftcHemisphere'};

                prePostPs = cat(1, prePostPs, {biomarkerActvDiff_RFTC.in.prePostP, biomarkerActvDiff_highEI.in.prePostP, biomarkerActvDiff_rftcConnected.in.prePostP,...
                  sameRFTC_Structure_ActvDiff.in.prePostP, sameRFTC_Lobe_ActvDiff.in.prePostP, sameRFTC_Hemisphere_ActvDiff.in.prePostP});
                
                prePostPs = cat(1, prePostPs, {biomarkerActvDiff_RFTC.out.prePostP, biomarkerActvDiff_highEI.out.prePostP, biomarkerActvDiff_rftcConnected.out.prePostP,...
                  sameRFTC_Structure_ActvDiff.out.prePostP, sameRFTC_Lobe_ActvDiff.out.prePostP, sameRFTC_Hemisphere_ActvDiff.out.prePostP}); 

                prePostPs = cat(1, prePostPs, {biomarkerActvDiff_RFTC.inOutP, biomarkerActvDiff_highEI.inOutP, biomarkerActvDiff_rftcConnected.inOutP,...
                  sameRFTC_Structure_ActvDiff.inOutP, sameRFTC_Lobe_ActvDiff.inOutP, sameRFTC_Hemisphere_ActvDiff.inOutP}); 

                plotData = {biomarkerActvDiff_RFTC; biomarkerActvDiff_rftcConnected; biomarkerActvDiff_highEI;...
                ...
                %plotIntraZoneBoxChart_verPaper(bmi, params, plotData, plotabels);
