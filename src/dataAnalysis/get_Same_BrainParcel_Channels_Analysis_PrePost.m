function get_Same_BrainParcel_Channels_Analysis_PrePost(paths, selDetector, analysisPerZonesTablePath, thList, features, normOptions, freqBandConnList, patsSelList, outcomeTh, connTh, eiTh)
    analysisType = {'Same_BrainParcel_Channels'};
    analysis = {};
    threshold = [];
    nrPats = [];
    nrChanns = [];
