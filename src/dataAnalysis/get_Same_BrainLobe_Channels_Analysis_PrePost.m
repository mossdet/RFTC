function get_Same_BrainLobe_Channels_Analysis_PrePost(paths, selDetector, analysisPerZonesTablePath, thList, features, normOptions, freqBandConnList, patsSelList, outcomeTh, connTh, eiTh)
    analysisType = {'Same_BrainLobe_Channels'};
    analysis = {};
    threshold = [];
    nrPats = [];
    nrChanns = [];
