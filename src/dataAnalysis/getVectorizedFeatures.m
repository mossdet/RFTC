...
features = {'Frequency', 'Power', 'Frequency'};
...
[zonesDataIn, zonesDataOut] = getAllData(paths, params, biomarkersList, normOptions, patsSelList, features);

function [zonesDataIn, zonesDataOut] = getAllData(paths, params, biomarkersList, normOptions, patsSelList, features)
    zonesDataIn = [];
    zonesDataOut = [];
    %% Analysis Loop
        ...
        for nmi = 1:length(normOptions)
            for psi = 1:length(patsSelList)
                for fi = 1:length(features)
                    ...
                    %% In Zones
                    %rftcSite
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcPre = biomarkerActvDiff_RFTC.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcPost = biomarkerActvDiff_RFTC.in.post;
                    (median(biomarkerActvDiff_RFTC.in.pre) - median(biomarkerActvDiff_RFTC.in.post))/ median(biomarkerActvDiff_RFTC.in.pre)*100
                    % rftcConnected
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcConnPre = biomarkerActvDiff_rftcConnected.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcConnPost = biomarkerActvDiff_rftcConnected.in.post;
                    (median(biomarkerActvDiff_rftcConnected.in.pre) - median(biomarkerActvDiff_rftcConnected.in.post))/ median(biomarkerActvDiff_rftcConnected.in.pre)*100
                    % rftcStruct
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcStructPre = sameRFTC_Structure_ActvDiff.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcStructPost = sameRFTC_Structure_ActvDiff.in.post;
                    (median(sameRFTC_Structure_ActvDiff.in.pre) - median(sameRFTC_Structure_ActvDiff.in.post))/ median(sameRFTC_Structure_ActvDiff.in.pre)*100
                    % highEI
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).highEI_Pre = biomarkerActvDiff_highEI.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).highEI_Post = biomarkerActvDiff_highEI.in.post;
                    (median(biomarkerActvDiff_highEI.in.pre) - median(biomarkerActvDiff_highEI.in.post))/ median(biomarkerActvDiff_highEI.in.pre)*100
                    % rftcLobe
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcLobePre = sameRFTC_Lobe_ActvDiff.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcLobePost = sameRFTC_Lobe_ActvDiff.in.post;
                    (median(sameRFTC_Lobe_ActvDiff.in.pre) - median(sameRFTC_Lobe_ActvDiff.in.post))/ median(sameRFTC_Lobe_ActvDiff.in.pre)*100
                    % rftcHemisphere
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcHemisPre = sameRFTC_Hemisphere_ActvDiff.in.pre;
                    zonesDataIn.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcHemisPost = sameRFTC_Hemisphere_ActvDiff.in.post;
                    (median(sameRFTC_Hemisphere_ActvDiff.in.pre) - median(sameRFTC_Hemisphere_ActvDiff.in.post))/ median(sameRFTC_Hemisphere_ActvDiff.in.pre)*100

                    %% Out Zones
                    %rftcSite
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcPre = biomarkerActvDiff_RFTC.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcPost = biomarkerActvDiff_RFTC.out.post;
                    % rftcConnected
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcConnPre = biomarkerActvDiff_rftcConnected.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcConnPost = biomarkerActvDiff_rftcConnected.out.post;
                    % rftcStruct
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcStructPre = sameRFTC_Structure_ActvDiff.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcStructPost = sameRFTC_Structure_ActvDiff.out.post;
                    % highEI
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).highEI_Pre = biomarkerActvDiff_highEI.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).highEI_Post = biomarkerActvDiff_highEI.out.post;
                    % rftcLobe
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcLobePre = sameRFTC_Lobe_ActvDiff.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcLobePost = sameRFTC_Lobe_ActvDiff.out.post;
                    % rftcHemisphere
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcHemisPre = sameRFTC_Hemisphere_ActvDiff.out.pre;
                    zonesDataOut.(params.biomarker).(params.normalization).(params.patsSel).(params.feature).rftcHemisPost = sameRFTC_Hemisphere_ActvDiff.out.post;
                end
            end 
        end
    end
...
function [groupTablePre, groupTablePost] = normalizePerPatient(groupTablePre, groupTablePost)
    ...
    groupTableAll = [];
    iesHFO_Feats = {'Patient', 'Biomarker', 'AvgPre', 'MedianPre', 'AvgPost', 'MedianPost', 'Outcome'};
    ...
    for pi = 1:nrPatients
        ...
        for ci = 1:length(columnNames)
            ...
            if ci >= 9
                if ci == 11
                    newEntree = {allPatNames{pi} column mean(groupTablePre.(column)(patSelIdx)) median(groupTablePre.(column)(patSelIdx))...
                        mean(groupTablePost.(column)(patSelIdx)) median(groupTablePost.(column)(patSelIdx)),...
                        mean(groupTablePre.outcome(patSelIdx))};
                    iesHFO_Feats = cat(1, iesHFO_Feats, newEntree);
                end
